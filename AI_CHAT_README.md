...
4. The **Model** dropdown in the AI Assistant lists only models whose provider is configured (e.g. models appear when the corresponding API key is set).
...
- **Tools:** `src/classes/ai_openshot_tools.py` – OpenShot tools (project state and actions) for the agent.
