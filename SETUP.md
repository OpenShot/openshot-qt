# OpenShot Video Editor – Setup (openshot-qt)

This repo is **OpenShot Video Editor** (Python 3, PyQt5). Follow these steps to set up and run it.
...
| Run GUI           | ✅ Use `./run.sh` after libopenshot is installed and display is available |
