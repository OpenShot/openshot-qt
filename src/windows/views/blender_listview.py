...
class Worker(QObject):
    ...
    finished = Signal()
    blender_version_error = Signal(str)
    blender_error_nodata = Signal()
    blender_error_with_data = Signal(str)
    progress = Signal(int)
    image_updated = Signal(str)
    frame_stage = Signal(str)
    frame_render = Signal(int, int)
    frame_saved = Signal(int)
    start_processing = Signal()
    end_processing = Signal()
